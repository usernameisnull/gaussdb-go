...
func TestInetTranscode(t *testing.T) {
	gaussdbxtest.RunValueRoundTripTests(context.Background(), t, defaultConnTestRunner, nil, "inet", []gaussdbxtest.ValueRoundTripTest{
...
func TestCidrTranscode(t *testing.T) {
	...
	gaussdbxtest.RunValueRoundTripTests(context.Background(), t, defaultConnTestRunner, nil, "cidr", []gaussdbxtest.ValueRoundTripTest{
		{mustParseInet(t, "0.0.0.0/32"), new(net.IPNet), isExpectedEqIPNet(mustParseInet(t, "0.0.0.0/32"))},
