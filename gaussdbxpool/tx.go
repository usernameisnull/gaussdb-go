...
func (tx *Tx) Prepare(ctx context.Context, name, sql string) (*gaussdbconn.StatementDescription, error) {
	return tx.t.Prepare(ctx, name, sql)
}

func (tx *Tx) Exec(ctx context.Context, sql string, arguments ...any) (gaussdbconn.CommandTag, error) {
