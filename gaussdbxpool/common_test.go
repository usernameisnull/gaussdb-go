...
type execer interface {
	Exec(ctx context.Context, sql string, arguments ...any) (gaussdbconn.CommandTag, error)
}
...
func assertConfigsEqual(t *testing.T, expected, actual *gaussdbxpool.Config, testName string) {
